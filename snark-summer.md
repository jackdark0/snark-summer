hello friends. the end of the lawsuit arc is approaching, but the war is just beginning.

recently, Whick did an incredibly insightful [stream]() outlining how snarkers operate, which i highly recommend. much of this post is a shameless copy/paste of the first few hours.

**many of you should not be directly engaging in counter-insurgency tactics**.
you are fighting a losing battle. this is not a disagreement about facts; this is conflict of narratives.
even if you have an autistic understanding of the facts, you are likely to get destroyed. these losers have spent dozens & dozens of hours refining their talking points and, more importantly, their framing. i have seen you in stream chats, i have listened to you in voice chats, many of you suck ass at this.

unironically, if you had good parents, a history of healthy relationships, and haven’t gone to therapy, it’ll be significantly harder for you to counter these tactics in real time. if this is you, consider taking a support role instead. in this scenario *trying & failing is worse than not trying at all*.
...
### call out their tactics when you see them.
...
never forget: the receipts you don’t collect immediately won’t be there when you need them.

if you have receipts, send them to me.
## fundamentals.
to understand the tactics, understand the structural logic behind them.
### legitimate actions become illegitimate thru coordination.
a single critical post is speech; thousands of critical posts echoing the same talking points is a harassment campaign. each individual act looks defensible in isolation; that’s by design. the goal is to make you argue about individual bricks while they build a wall. don’t let the conversation atomize into isolated incidents. focus on the pattern.

the workflow is simple: clip → workshop talking points → distribute → boost → repeat. there is no smoking gun. the only chance of one won’t be out until Steven releases the expose; hell, that might not even be as explicit as we want it to be.

focus on patterns, not incidents. get timestamps; mark co-occurrences.
### frame control.
most of these revolve around dodging accountability on their side & shifting the framing of the conversation to put you on defense. as Dear Leader always says: *the best-case scenario while defending is not losing ground*. this is not how you win.
### plausible deniability is structural, not accidental.
the key figures don’t need to issue direct orders, instead they create a culture which rewards escalation & identifies targets without explicit instruction. “i wouldn’t do it, but i understand why someone would” isn’t a neutral, descriptive observation; it’s a permission structure.

responsibility doesn’t require a paper trail. ask who is naming targets, who framed them as deserving, who rewarded escalation.
### unwitting participants as cover.
many people spreading snarker talking points don’t know they’re spreading snarker talking points. they pick them up organically & believe it. this is what gives them plausible deniability & makes it harder to attribute.
...
> *“You’re deflecting from [your side’s] actual crimes.”*
> *“Why aren’t you talking about [your side’s] behavior?”*
